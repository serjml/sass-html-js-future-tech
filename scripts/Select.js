...
class Select extends BaseComponent {
  ...
  updateUI() {
    ...
    const updateButton = () => {
      ...
      this.buttonElement.classList.toggle(this.stateClassses.isExpanded, isExpanded);
    ...
    const updateDropdown = () => {
      this.dropdownElement.classList.toggle(this.stateClassses.isExpanded, isExpanded);
    };
    ...
    const updateOptions = () => {
      this.optionElements.forEach((optionElement, index) => {
        ...
        optionElement.classList.toggle(this.stateClassses.isCurrent, isCurrent);
        optionElement.classList.toggle(this.stateClassses.isSelected, isSelected);
  ...
  fixDropdownPosition() {
    ...
    this.dropdownElement.classList.toggle(
      this.stateClassses.isOnTheLeftSide,
      isButtonOnTheLeftViewportSide,
    );

    this.dropdownElement.classList.toggle(
      this.stateClassses.isOnTheRightSide,
      !isButtonOnTheLeftViewportSide,
    );
  }
